...
message("Merged cells: ", ncol(all_combined_data))
...
# head(all_combined_data@meta.data[, c("seurat_clusters", "CellType")])

# fibro_clusters <- all_combined_data@meta.data %>%
